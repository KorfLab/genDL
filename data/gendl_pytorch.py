...
parser.add_argument('--file', required=False, type=str,
    metavar='<path>', help='path to yaml file') ##implement it with a file later on
...
def reading_the_file(file):
    with open(arg.file) as f:
        information = yaml.load_all(f, Loader=yaml.FullLoader)
        print(type(information))
        return (input_dim, output_dim, hidden_dim_array, non_linear_function_array)
