...
def create_model(X, layer1=5, layer2=5):  # Using 5 as a placeholder
  NN = keras.Sequential()
  # Hidden layer 1
...
def pick_layer_size(x_train, y_train):
  ...
  param_grid={'layer1':[3,6,9,12,15,18,21], 'layer2':[3,6,9,12,15,18,21]}
