...
### x_val =cross-validation level = 10-fold validation
...
model = keras.Sequential([
	...
	keras.layers.Dense(336, activation='elu'),
#		kernel_regularizer=tf.keras.regularizers.l2(0.001)),
	#keras.layers.Dropout(0.50),
#	keras.layers.Dense(42, activation='elu',
#		kernel_regularizer=tf.keras.regularizers.l2(0.001)),
#	keras.layers.Dropout(0.50),
	keras.layers.Dense(168, activation='elu'),
	keras.layers.Dense(168, activation='elu'),
	keras.layers.Dense(168, activation='elu'),
	keras.layers.Dense(168, activation='elu'),
#		kernel_regularizer=tf.keras.regularizers.l2(0.001)),
...
model.fit(seqs_train, labels_train, epochs=25, batch_size=10,
	validation_data=(seqs_val, labels_val), callbacks=[tensorboard])
print(model.summary())
